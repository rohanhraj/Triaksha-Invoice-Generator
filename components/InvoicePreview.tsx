      ...
      <div className="border border-black flex-1 flex flex-col overflow-hidden">
        ...
        <div className="shrink-0 flex flex-col">
          ...
          <div className="flex divide-x divide-black min-h-[80px]">
             ...
             <div className="w-1/2 p-2 flex flex-col justify-between items-center relative">
                <div className="mt-auto text-center w-full">
                  <p className="text-[7px] font-bold text-gray-400 mb-2 uppercase">Authorised Signatory For</p>
                  <p className="font-black uppercase text-[10px]">{data.signatureName}</p>
                </div>
                <div className="absolute top-4 w-20 h-6 opacity-10">
                   <svg viewBox="0 0 100 40" className="w-full h-full text-[#7c6d62]">
                      <path d="M10,30 Q30,10 50,25 T90,15" fill="none" stroke="currentColor" strokeWidth="1" />
                   </svg>
                </div>
             </div>
          </div>
