      ...
      <section>
        ...
        <div className="grid grid-cols-1 gap-3">
          ...
          <input
            ...
            value={data.buyer.addressLine2}
            onChange={e => updateBuyer('addressLine2', e.target.value)}
          />
          <input
            className="border p-2 rounded text-sm w-full"
            placeholder="GSTIN"
      ...
      <section>
        ...
        <div className="grid grid-cols-1 gap-3">
          ...
          <input
            className="border p-2 rounded text-sm w-full"
            placeholder="Address Line 2 (City, Pincode)"
            value={data.consignee.addressLine2}
            onChange={e => updateConsignee('addressLine2', e.target.value)}
          />
        </div>
      </section>
